                        ...
                        <tbody>
                            ...
                            while ($pecah = $ambil->fetch_assoc()) { ?>
                                <tr>
                                    ...
                                    <td><?php echo date('Y-m-d H:i', strtotime($pecah['tanggal_pembayaran'])); ?></td>
                                    <td><?php echo "Rp " . number_format($pecah['jumlah_pembayaran'], 0, ',', '.'); ?></td>
                                    <td>
                                        <button class="delete-button"> <a
                                                href="Invoice.php?halaman=hapus karyawan&id=<?php echo $pecah['id'] ?>">Hapus</a>
                                        </button>
                                    </td>
                                </tr>
                                <?php $nomor++;
