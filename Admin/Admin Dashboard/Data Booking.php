...
if (isset($_GET['Id'])) {
    ...
    echo "<meta http-equiv='refresh' content='1;url= Data Booking.php'>";
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="edit-button">
                                            <a
                                                href="../Update/Update Data Booking.php?halaman=ubah bookingk&Id=<?php echo $pecah['Id'] ?>">Edit</a>
                                        </button>
                                        <button class="delete-button">
                                            <a
                                                href="Data Booking.php?halaman=hapus booking&Id=<?php echo $pecah['Id'] ?>">Hapus</a>
                                        </button>
                                    </td>
                                </tr>
                                <?php $nomor++;
