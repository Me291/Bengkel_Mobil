...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $delete = mysqli_query($conn, "DELETE FROM `data_karyawan` WHERE `id`= '$id'");
    echo "<script>alert('Data Berhasil Dihapus');</script>";
    echo "<meta http-equiv='refresh' content='1;url= Data Admin.php'>";
...
<body>
    ...
    <div class="content">
        ...
        <main>
            <div class="header">
                <a href="../Input/Input Karyawan.php" class="report">
            ...
            <div class="bottom-data">
                <div class="orders">
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php $nomor = 1;
                            $ambil = $conn->query("SELECT * FROM data_karyawan");
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="edit-button">
                                            <a
                                                href="../Update/Update Data Karyawan.php?halaman=ubah karyawank&id=<?php echo $pecah['id'] ?>">Edit</a>
                                        </button>
                                        <button class="delete-button"> <a href="Data Admin.php?halaman=hapus karyawan&id=<?php echo $pecah['id'] ?>">Hapus</a> </button>
                                    </td>
                                </tr>
                                <?php $nomor++;
                            } ?>
